import { Component, ChangeDetectionStrategy, ChangeDetectorRef, OnDestroy, HostBinding, HostListener, ElementRef } from '@angular/core';
...
export class CheckboxComponent extends WithStateBase<CheckboxState> implements OnDestroy {
